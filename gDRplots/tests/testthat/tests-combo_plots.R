...
test_that("gDR_combo_plot works as expected", {
  cl_name <- "cellline_FD"
  drug1_name <- "drug_011"
  drug2_name <- "drug_026"
  norm_type <- "RV"
  ...
  plts_1 <- gDR_combo_plot(se, drug1_name, drug2_name, cl_name)
  ...
  plts_2 <- gDR_combo_plot(se, drug1_name, drug2_name, cl_name, normalization_type)
