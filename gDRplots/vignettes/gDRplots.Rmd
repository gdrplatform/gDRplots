...
Note: It requires special dedicated calculated with `prep_dt_depmap_feat` function and one of the functions
...
Note: It requires special dedicated calculated with `prep_dt_depmap_meta` function and one of the functions
with experimental response data for one metric: `prep_dt_response_metric_sa`, `prep_dt_response_dose_sa`, `prep_dt_response_scores` or `prep_dt_response_metric_diff`. 
