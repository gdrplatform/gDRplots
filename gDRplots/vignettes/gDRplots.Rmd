...
For experiments with drug combinations, users can visualize the full response matrix in the panel by using **heatmap_combo_metrics_panel** function. 
...
heatmap_combo_metrics_panel(dt_excess = dt_excess,
...
```{r heatmap_control_mapping_qc, warning = FALSE, message = FALSE, eval = FALSE}
...
plot_plate_stack_info(merged_data)
plot_plate(merged_data, "ReadoutValue")gDRplots/vignettes/gDRplots.Rmd
```
