...
Note: It requires dedicated input calculated with `prep_dt_depmap_feat` function and one of the functions with experimental response data for one metric: `prep_dt_response_metric_sa`, `prep_dt_response_dose_sa`, `prep_dt_response_scores` or `prep_dt_response_metric_diff`.
...
Users can also use **plot_boxplot_num_panel** to get a panel with the box plot with category distribution
for list of the DepMap matadata.

![](plot_boxplot_num.png)
