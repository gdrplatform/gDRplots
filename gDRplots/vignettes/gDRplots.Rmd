...
Users can also use **heatmap_combo_metrics_panel** to get a panel with heatmaps for all comobo metrics, with isobolograms overlaid. The CI plot is also shown (the Combination Index is displayed at different ratios of the two drugs).
