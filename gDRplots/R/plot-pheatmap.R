...
pheatmap_with_anno_sa <- function(
  ...
  if (!is.null(annotation_colors)) {
    # trim annotation
    annotation_colors <- lapply(names(annotation_colors), function(nm) {
      if (any(nchar(names(annotation_colors[[nm]])) > max_hm_lbl_length)) {
