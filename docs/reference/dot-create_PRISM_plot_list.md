...
This internal function was created to avoid code duplication and
maintain consistency. For user, it is contained in a single-purpose
function, depending on the experiment type.
...
- experiment_type:
  ...
  string with the type of experiment one of: "sa" for the single-agent
  experiment "combo" for the combination experiment
