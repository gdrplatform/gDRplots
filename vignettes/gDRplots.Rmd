...
**TIP**<br>
It is highly recommended to use `gDRutils::convert_se_assay_to_dt` with 
...
_Note_: It requires dedicated input calculated with `prep_dt_assoc` function.

Users can also use **plot_volcano_assoc_panel** to get a panel with the volcano plot and scatter plots or box plots for interesting variables - according to the type of data (numerical feature or categorical feature, respectively).

![](plot_volcano_feat_scatt.png)

![](plot_volcano_feat_box.png)
...
_Note_: It requires dedicated input calculated with `prep_dt_depmap_feat` function and one of the functions with experimental response data for one metric: `prep_dt_response_metric_sa`, `prep_dt_response_dose_sa`, `prep_dt_response_scores` or `prep_dt_response_metric_diff`.


Users can also use **plot_scatter_with_corr_panel** to get a panel with the scatter plot with correlation for list of the DepMap features as a table.
...
_Note_: It requires dedicated input calculated with `prep_dt_depmap_meta` function and one of the functions
